          ...
          <div className="space-y-4 text-gray-700">
            ...
            <div>
              ...
              <div className="flex items-center space-x-5">
                ...
                <a 
                  ...
                  target="_blank"
                  className="flex items-center text-sm opacity-80 hover:opacity-100 hover:text-blue-600 transition-colors cursor-pointer mx-2"
                ...
                <a 
                  ...
                  rel="noreferrer noopener" 
                  target="_blank"
                  className="flex items-center text-sm opacity-80 hover:opacity-100 hover:text-blue-600 transition-colors cursor-pointer"
            ...
            <div>
              ...
              <a 
                ...
                rel="noreferrer noopener" 
                target="_blank"
                className="text-sm opacity-80 hover:opacity-100 hover:text-blue-600 transition-colors cursor-pointer underline block"
              >
                Nerbollttagoo
              </a>
              <a 
